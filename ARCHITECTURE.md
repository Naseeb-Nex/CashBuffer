...
1.  **Strict Foreign Keys:** Every functional table (`transactions`, `categories`, `vendor_rules`, `llm_configs`) has a `user_id` mapped strictly to the Kinde Subject claim.
